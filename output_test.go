...
func TestGetOPReturnData(t *testing.T) {
	...
	txm[opReturnTx1] = []response{notOPReturn, notOPReturn, {true, 20, 0x20}} // P2PKH, P2PKH, OP_RETURN
	txm[opReturnTx2] = []response{notOPReturn, {true, 32, 0x55}}              // P2SH, OP_RETURN
	txm[opReturnTx3] = []response{notOPReturn, {true, 20, 0x20}, notOPReturn} // P2SH, OP_RETURN, P2PKH
	txm[opReturnTx4] = []response{notOPReturn, {true, 20, 0x50}, notOPReturn} // P2PKH, OP_RETURN, P2PKH
...
func TestIsP2MSOutput(t *testing.T) {
	...
	txm[tx8] = []result{noP2MS, noP2MS}                // P2SH, P2WSH
	txm[tx13] = []result{{true, 1, 1}, noP2MS, noP2MS} // P2MS 1-of-1, P2PKH, P2PKH
	txm[tx14] = []result{{true, 2, 3}}                 // P2MS 2-of-3
	txm[tx15] = []result{{true, 3, 3}, noP2MS, noP2MS} // P2MS 3-of-3, P2PKH, P2PKH
